 ...
 *
 */
public class TestFighterAggresive extends FighterRobot {
	...
	public TestFighterAggresive(City c, int a, int s, Direction d, int id, int health) {
	...
	private double calcPriority(OppData opponent) {
		double priority;
		priority = (opponent.getHealth()/100)*3+(calculateDist(opponent)/32);
		return priority;
	}
