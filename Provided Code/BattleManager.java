...
public class BattleManager {
	...
	private static void createPlayers()
	{
		...
		player[0] = new TestFighterRunner(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.SOUTH, 0, MAX_HEALTH);
		player[1] = new TestFighterAggresive(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.EAST, 1, MAX_HEALTH);
		player[2] = new TestFighterBalanced(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.EAST, 2, MAX_HEALTH);
		player[3] = new TestFighterDefensive(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.EAST, 3, MAX_HEALTH);
		player[4] = new MaFighterRobot(arena,generator.nextInt(HEIGHT),generator.nextInt(WIDTH),Direction.EAST, 4, MAX_HEALTH);
